...
function LandingComponents() {
  return (
    <section className="bg-light-pageBg dark:bg-dark-pageBg p-4 flex flex-col items-center pt-16">
      <AiCard  />
      <h1  data-aos="fade-up"  className="dark:text-dark-headingText text-light-headingText text-4xl md:text-5xl lg:text-6xl font-bold text-center my-4 lg:leading-tight md:leading-tight sm:leading-tight">
