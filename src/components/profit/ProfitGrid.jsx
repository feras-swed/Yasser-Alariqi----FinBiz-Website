  ...
  return (
    <section className="container ">
      <div className=" grid grid-cols-12 gap-4 mt-8 md:gap-6 rounded-3xl lg:mx-20 dark:bg-dark-priceCardBg bg-light-buttonBg p-4 relative z-20">
        ...
        {/* First Card */}
        <div data-aos="fade-right" className="bg-white flex flex-col justify-between dark:bg-dark-pageBg col-span-12 lg:col-span-4 rounded-2xl border-2 border-neutral-800 text-center text-black dark:text-white p-6">
          ...
          <div className="flex justify-between mt-7 items-end">
            <h4 className="text-5xl">$350.240</h4>
            <img src="/graphG.svg"/>
          </div>
        </div>

        {/* Second Card */}
        <div data-aos="zoom-in" className="bg-white dark:bg-dark-pageBg col-span-12 lg:col-span-4 rounded-2xl border-2 border-neutral-800 text-center text-black dark:text-white p-6">
          <header className="flex justify-between">
              <p className="text-lg font-light">Total revenue</p>
              <p className="text-sm text-red-600 font-semibold">+28.35</p>
            </header>
            <div className="flex justify-between mt-7 items-end">
              <h4 className="text-5xl">$400.690</h4>
              <img src="/graphR.svg"/>
            </div>
        </div>

        {/* Third Card */}
        <div data-aos="fade-left" className="bg-white dark:bg-dark-pageBg col-span-12 lg:col-span-4 rounded-2xl border-2 border-neutral-800 text-center text-black dark:text-white p-6">
          <header className="flex justify-between">
            <p className="text-lg font-light">Product sold</p>
            <p className="text-sm text-blue-600 font-semibold">+28.35</p>
          </header>
          <div className="flex justify-between mt-7 items-end">
            <h4 className="text-5xl">$200.000</h4>
            <img src="/graphB.svg"/>
          </div>
        </div>

        {/* Fourth Card */}
        <div data-aos="fade-right" className="bg-white dark:bg-dark-pageBg col-span-12 lg:col-span-2 rounded-2xl border-2 border-neutral-800 text-start text-black dark:text-white p-4">
        ...
        {/* Sixth Card */}
        <div data-aos="fade-left" className="flex flex-col justify-between col-span-12 lg:col-span-2 rounded-2xl text-start text-black dark:text-white p-2">
            <div className="mt-2">
              <h5>Employee</h5>
