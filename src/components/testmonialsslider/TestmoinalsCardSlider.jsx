...
function TestmoinalsCardSlider() {
    ...
    let testimonials = [
        ...
        },
        {
            ...
            name: "Alfredo Lubin",
            image: "./user2.svg",
            description: " “We alighn our succeess with the success of our customers which is why our offering transcends our software”.",
            starts : 5
        },
        {
            id: 3,
  ...
  return (
    <section className=" dark:bg-dark-navbarBg bg-white" >
    <div  className="container mx-auto py-10 md:py-20 px-4 lg:px-24">
        ...
        />
        <div data-aos="fade-up"  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
        ...
        <div data-aos="zoom" className="flex justify-center mt-10 gap-3">
            <button className='w-12 h-12 rounded-full bg-white dark:bg-dark-buttonBg text-black dark:text-white'><i class="fa-solid fa-arrow-left"></i></button>
            <button className='w-12 h-12 rounded-full bg-dark-lightGreen text-black'><i class="fa-solid fa-arrow-right"></i></button>
        </div>
